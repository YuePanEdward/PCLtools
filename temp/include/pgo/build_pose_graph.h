...
namespace lo
{
	...
	public:
		...
		int find_overlap_registration_constraint(cloudblock_Ptrs &blocks, constraints &cons,
												 ...
												 bool search_neighbor_2d = true, int max_neighbor = 7); //add to cons [search_neighbor_2d: true 2d, false 3d]
		...
		Eigen::Matrix4d double_check_tran(Eigen::Matrix4d &global_reg_tran, Eigen::Matrix4d &lo_predicted_tran,
										  double translation_thre = 6.0, double rotation_deg_thre = 30.0);
