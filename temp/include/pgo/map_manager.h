//
// This file is for the implements of the map management in Multi-Metrics Linear Least Square Lidar Odometry And Mapping (MMLLS-LOAM)
...
namespace lo
{
  ...
  public:
    ...
    bool update_cloud_vectors(pcTPtr feature_pts, const pcTreePtr map_kdtree,
                              ...
                              int k_min = 8, float sin_low = 0.0, float sin_high = 1.0);
