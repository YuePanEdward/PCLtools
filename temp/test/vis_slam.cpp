...
int main(int argc, char **argv)
{
    ...
    MapViewer<Point_T> mviewer(0.0, 1, 0, 0); //downsampling ratio
    ...
    poses_gt_lidar_cs = dataio.load_poses_from_transform_matrix(gt_pose_lidar_cs_file, frame_begin, frame_step);
    poses_lo_lidar_cs = dataio.load_poses_from_transform_matrix(lo_pose_lidar_cs_file, frame_begin, frame_step);
